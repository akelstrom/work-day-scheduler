...
//ATTENTION!! this is commented out because I am having issues. The function DOES work when local storage 
//is set up but it does not work when local storage is empty. Will fix in class
//loadStoredData();